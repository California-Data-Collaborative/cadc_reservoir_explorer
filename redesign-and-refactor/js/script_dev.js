...
var capacityLayer;
// var nav_height = $(".navbar.navbar-dark.bg-dark").height();
function styleSetup(){
...
//   $("#content").css("min-height", `calc(100vh - ${nav_height}px)`);
//   $("#mapPanel, #detailPanel").css("height", `calc(100vh - ${nav_height}px)`);
